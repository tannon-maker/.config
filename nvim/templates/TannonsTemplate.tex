...
\documentclass{report} % Changed to report document class
\usepackage{amsthm}
...
\newtcolorbox{myexamplebox}[1][]{
    myexample,
    #1
}

\newtcolorbox{mytheorembox}[1][]{
    mytheorem,
    #1
}

\newtcolorbox{mydefinitionbox}[1][]{
    mydefinition,
    #1
}

\newtcolorbox{mynotebox}[1][]{
    mynote,
    #1
}
